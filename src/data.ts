...
export const dimensionResources: Record<string, DimensionResources> = {
  uso: {
      ...
      resources: [
        {
          ...
          description: "O livro que define como pensar sobre IA como parceira, não ferramenta. Base de tudo.",
          url: "https://www.oneusefulthing.org/p/what-just-happened-with-ai-is-too",
          type: "article",
        },
        {
          title: "As 4 regras da Co-Inteligência",
          description: "Sempre convide IA pra mesa, seja o humano no loop, e trate IA como uma pessoa (mas especifique qual).",
          url: "https://www.oneusefulthing.org/p/how-to-use-ai-to-do-practical-stuff",
          type: "guide",
        },
        {
          title: "Claude Code — CLI para desenvolvedores",
          description: "Ferramenta prática para times de dev começarem a experimentar com IA no terminal.",
    ...
    mid: {
      ...
      resources: [
        {
          title: "A fronteira irregular da IA",
          description: "Entenda por que IA é excelente no que parece difícil e falha no que parece fácil. Teste empiricamente.",
          url: "https://www.oneusefulthing.org/p/centaurs-and-cyborgs-on-the-jagged",
          type: "article",
        },
        {
          title: "Centauros vs Cyborgs: dois padrões de uso",
          description: "Centauros dividem tarefas. Cyborgs integram IA em cada passo. Qual é o estilo do seu time?",
    ...
    high: {
      ...
      resources: [
        {
          title: "Construindo grimórios para o time",
          description: "Como criar bibliotecas de prompts testados, casos de uso e fronteira mapeada.",
  ...
  lideranca: {
    low: {
      ...
      resources: [
        {
          title: "O papel do líder na adoção de IA",
          description: "Se o chefe não usa, ninguém usa. Sponsorship ativo é o fator #1 de sucesso (Prosci).",
          url: "https://www.prosci.com/blog/executive-sponsor-role",
          type: "article",
        },
        {
          title: "O problema do 'ciborgue secreto'",
          description: "Quando a empresa não tem política clara, as pessoas usam IA escondidas. Isso cria dependências invisíveis.",
          url: "https://www.oneusefulthing.org/p/the-secret-cyborg",
          type: "article",
        },
        {
          title: "AI Transformation Playbook — Andrew Ng",
          description: "O playbook completo de transformação com IA. Passo 5: comunicação interna honesta sobre medo de perder emprego.",
    ...
    mid: {
      ...
      resources: [
        {
          title: "Regra 10/20/70 — BCG",
          description: "70% do investimento deve ir em pessoas e processos, não em tecnologia. A liderança é parte crítica dos 70%.",
    ...
    high: {
      ...
      resources: [
        {
          title: "ADKAR: Reforço é a fase esquecida",
          description: "A maioria para no treinamento. Reforço contínuo com métricas e reconhecimento é o que sustenta a mudança.",
  ...
  processos: {
    low: {
      ...
      resources: [
        {
          title: "IA muda workflows, não só ferramentas",
          description: "Entenda por que usar IA sem redesenhar o processo é como usar um carro na trilha do cavalo.",
          url: "https://www.oneusefulthing.org/p/reshaping-the-tree-rebuilding-organizations",
          type: "article",
        },
        {
          title: "Design Patterns para Agentes de IA — Andrew Ng",
          description: "4 padrões de design: Reflexão, Uso de Ferramentas, Planejamento e Multi-Agente.",
      ...
      resources: [
        {
          ...
          description: "Critérios: dado acessível, resultado mensurável, baixo risco, pessoa curiosa disponível.",
          url: "https://landing.ai/resources/ai-transformation-playbook",
          type: "guide",
        },
      ],
    ...
    high: {
      ...
      resources: [
        {
          title: "De experimental a operacional",
          description: "O gap entre 'funciona no demo' e 'funciona no dia a dia' é onde 60-70% do valor se perde (McKinsey).",
  ...
  dados: {
    low: {
      ...
      resources: [
        {
          title: "Data-Centric AI — Andrew Ng",
          description: "O gargalo não é o modelo, é a qualidade dos dados. Foque em organizar dados, não em escolher ferramentas.",
          url: "https://www.deeplearning.ai/the-batch/a-chat-with-andrew-on-mlops/",
          type: "article",
        },
        {
          title: "LGPD e uso de IA com dados empresariais",
          description: "O que pode e o que não pode ser enviado para APIs de LLM no contexto brasileiro.",
          url: "https://www.gov.br/esporte/pt-br/acesso-a-informacao/lgpd",
          type: "guide",
        },
      ],
    },
    mid: {
      ...
      resources: [
        {
          title: "Governança de dados mínima para PMEs",
          description: "Você não precisa de um data lake. Precisa saber o que é sensível, o que é público, e o que IA pode acessar.",
    ...
    high: {
      ...
      resources: [
        {
          title: "RAG: Conectando seus dados a modelos de linguagem",
          description: "Como alimentar IA com o contexto específico do seu negócio sem retreinar modelos.",
  ...
  documentacao: {
    low: {
      ...
      resources: [
        {
          title: "O conceito de 'Grimório' de Mollick",
          description: "Bibliotecas vivas de prompts testados e contexto documentado. A versão corporativa do livro de feitiços.",
          url: "https://www.oneusefulthing.org/p/on-boarding-your-ai-intern",
          type: "article",
        },
        {
          title: "CLAUDE.md: Contexto que viaja com o projeto",
          description: "Como criar um arquivo de contexto que alimenta IA automaticamente sobre o projeto.",
    ...
    mid: {
      ...
      resources: [
        {
          title: "De documentação para contexto",
          description: "Documentação tradicional é para humanos lerem. Contexto para IA precisa ser estruturado diferente.",
    ...
    high: {
      ...
      resources: [
        {
          title: "Revisão de fronteira: quando atualizar o grimório",
          description: "A cada 3-6 meses, o que IA faz bem muda. Revise seu catálogo de prompts e casos de uso.",
  ...
  metricas: {
    low: {
      ...
      resources: [
        {
          title: "Estudo BCG/Harvard: impacto medido de IA",
          description: "758 consultores: 25% mais rápidos, 40% melhor qualidade DENTRO da fronteira. 23% PIORES fora. Medir é essencial.",
          url: "https://www.bcg.com/publications/2023/how-people-create-and-destroy-value-with-gen-ai",
          type: "article",
        },
        {
          title: "Modelo de ROI simplificado para PMEs",
          description: "Dev entregando 2x = economia de contratação. Análise que levava 2 semanas em 15 min = velocidade de decisão.",
          url: "https://landing.ai/resources/ai-transformation-playbook",
          type: "guide",
        },
      ],
    ...
    mid: {
      ...
      resources: [
        {
          title: "Leading vs Lagging: o que medir primeiro",
          description: "Leading: frequência de uso, atualizações de grimório. Lagging: produtividade, qualidade, velocidade.",
          url: "https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai",
          type: "article",
        },
      ],
    ...
    high: {
      ...
      resources: [
        {
          title: "De piloto a programa: escalando com dados",
          description: "Use o caso de sucesso medido para propor expansão. ROI documentado é o melhor argumento.",
          url: "https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai",
          type: "article",
        },
      ],
